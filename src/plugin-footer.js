export function install (hook, vm) {
    ...
    let auth = vm.config.footer && vm.config.footer.auth ? vm.config.footer.auth : '<span>Published with <a href="https://github.com/docsifyjs/docsify" target="_blank" rel="noreferrer" rel="noopener">docsify</a>.</span>';
